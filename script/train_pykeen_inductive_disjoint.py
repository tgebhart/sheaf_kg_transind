...
def run(model, dataset_name, version, num_epochs, random_seed,
        ...
        eval_every=EVAL_EVERY, convergence_tol=CONVERGENCE_TOL):
...
############## EVALUATION #################
    ...
    orig_model, interior_mask = expand_model_to_inductive_graph(training_model, {}, inference_graph)
...
if __name__ == '__main__':
    ...
    run(args.model, args.dataset, args.version, args.num_epochs, args.random_seed,
        args.embedding_dim, c1_dimension=args.c1_dimension, eval_graph=EVAL_GRAPH)
