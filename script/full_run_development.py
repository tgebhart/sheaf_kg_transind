...
from train_pykeen_from_config import run as train
...
if __name__ == "__main__":
    ...
    print(
        f"{strblock} RUNNING {args.dataset} {args.dataset_pct} {args.hpo_config_name} {strblock}"
    )
    ...
    reason(
        ...
        eval_graph_type=args.eval_graph,
        evaluation_batch_size=args.batch_size,
        evaluation_slice_size=args.slice_size,
        alpha=args.alpha,
        diffusion_iterations=args.diffusion_iterations,
        train_complex=False,
        development=True,
