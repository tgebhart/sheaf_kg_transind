...
def run(hpo_config_name, dataset_name, version, train_graph=TRAIN_GRAPH, eval_graph=EVAL_GRAPH):
...
if __name__ == '__main__':
    ...
    run(args.hpo_config_name, args.dataset, args.version, train_graph=args.train_graph, eval_graph=args.eval_graph)
