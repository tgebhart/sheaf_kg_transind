...
from data_tools import get_disjoint_dataset, get_model_name_from_config, get_eval_graph
...
def run(hpo_config_name, dataset=DATASET, evaluate_device=EVALUATION_DEVICE, diffusion_device=DIFFUSION_DEVICE, 
    ...
    with torch.no_grad():
        ...
        orig_model, interior_mask = expand_model_to_inductive_graph(orig_model, {}, inference_graph)
