...
from data_tools import get_model_name_from_config, load_hpo_config
...
if __name__ == "__main__":
    ...
    training_args.add_argument(
        "--diffusion-batch-size", type=int, default=None, help="diffusion batch size"
    )
    training_args.add_argument(
        "--eval-every",
        type=int,
    ...
    print(
        f"{strblock} RUNNING {args.dataset} {args.version} {args.hpo_config_name} {strblock}"
    )
